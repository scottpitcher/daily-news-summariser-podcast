      ...
      <div className="space-y-7">
        {briefing.articles.map((article) => (
          <div key={`${article.rank}-${article.title}`}>
            <h3 className="text-[#1a1a2e] text-base font-bold mb-1.5">{article.headline}</h3>
            ...
            {article.soWhat && (
              <p className="text-sm text-gray-700 leading-relaxed mb-2.5 bg-[#e94560]/[0.06] rounded-lg px-3 py-2">
            ...
            <p className="text-xs text-gray-400">
              ...
              {article.sourceUrl ? (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="underline hover:text-[#1a1a2e] transition-colors"
                >
