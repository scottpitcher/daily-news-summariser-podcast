...
LOCAL_SOURCES: Final[dict[str, list[dict[str, object]]]] = {
    "new_york_city": [
        _source(
            ...
            homepage_url="https://www.nyc.gov/office-of-the-mayor/news.page",
            rss_url=None,
            level="local",
            source_type="html",
        ),
    ...
    "los_angeles": [
        _source(
            name="City of Los Angeles News",
            homepage_url="https://www.lacity.gov/news",
            rss_url=None,
            level="local",
            source_type="html",
        ),
        _source(
            name="LAist",
            homepage_url="https://laist.com/",
            rss_url="https://laist.com/feeds/atom.xml",
            level="local",
            source_type="rss",
        ),
    ],
    "austin": [
        _source(
            name="City of Austin News",
            homepage_url="https://www.austintexas.gov/news",
            rss_url=None,
            level="local",
            source_type="html",
        ),
        _source(
            name="Austin Monitor",
            homepage_url="https://www.austinmonitor.com/",
            rss_url="https://www.austinmonitor.com/stories/feed/",
            level="local",
            source_type="rss",
        ),
    ],
